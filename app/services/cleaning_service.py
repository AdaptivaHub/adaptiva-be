...
Provides comprehensive data cleaning functionality including:
...
Uses composite keys (file_id:sheet_name) for Excel files to ensure
...
def clean_data(request: DataCleaningRequest) -> DataCleaningResponse:
    ...
    Returns:
        DataCleaningResponse with detailed cleaning results and log
    """
    try:
